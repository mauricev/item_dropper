...
class DropdownPositionCalculator {
  ...
  static DropdownPositionResult calculate({
    ...
    final double inputFieldBottomScreen =
        inputFieldScreenPos.dy + inputFieldHeight;
    ...
    final double constrainedMaxHeight =
        (shouldShowBelow ? availableSpaceBelow : availableSpaceAbove).clamp(
          0.0,
          maxDropdownHeight,
        );
    ...
    final Offset offset = shouldShowBelow
        ...
        : Offset(
            0.0,
            -constrainedMaxHeight - ItemDropperConstants.kDropdownMargin,
          );
